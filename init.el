...
(cond ((string= system-type "gnu/linux")
	 ...
	 ;;     (load-file "~/.config/emacs/config/packages/lsp.el")
         (load-file "./config/packages/language-server.el")
         (load-file "~/.config/emacs/config/packages/theme.el")
	 ;;         (load-file "./config/packages/theme.el")
         (load-file "./config/packages/ace-windows.el")
         (load-file "./config/packages/terminal.el")
         ))
